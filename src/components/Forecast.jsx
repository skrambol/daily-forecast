      ...
      {forecast.DailyForecasts.map((f) => {
        return (
          ...
          >
            ...
            <p>
              RealFeel®: {f.RealFeelTemperature.Maximum.Phrase}{" "}
              <Temperature
                value={f.RealFeelTemperature.Maximum.Value}
                unit={f.RealFeelTemperature.Maximum.Unit}
              />{" "}
              <Temperature
                value={f.RealFeelTemperature.Minimum.Value}
                unit={f.RealFeelTemperature.Minimum.Unit}
              />
            </p>
